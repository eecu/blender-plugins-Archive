...
class RemoveUpdate(bpy.types.Operator):
    bl_idname = "machin3.remove_curvemachine_update"
...
class UseFoundUpdate(bpy.types.Operator):
    bl_idname = "machin3.use_curvemachine_update"
    ...
    def description(cls, context, properties):
        return f"Install curvemachine {properties.tail} from {properties.path}"
...
class ReScanUpdates(bpy.types.Operator):
    bl_idname = "machin3.rescan_curvemachine_updates"
